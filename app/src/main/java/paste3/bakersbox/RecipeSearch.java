...
public class RecipeSearch extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipeNameList= new String[]{"Cherry pie", "Doughnuts", "Victoria sponge",
                "Bakewell tarts", "Apple pie", "Lemon meringue", "Forest gateau", "Apple crumble",
                "Rhubarb crumble","Chocolate gateau"};
